...
class BackupDetailDialog(QDialog):
    ...
    def __add_desc_label(self, vbox: QVBoxLayout):
        label = QLabel("After restoration, anki-vocab-builder's data will be replaced by the restored one,  Anki's data (including decks, added words, etc) will not be affected, are you sure you want to restore?")
    ...
    def __start_restore(self, backup: Backup, backup_service: BackupService):
        ...
        msg.setText("Restoration finished! Please reopen anki-vocab-builder.")
