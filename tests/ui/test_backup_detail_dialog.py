...
class BackupDetailDialogTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.__backup_service = BackupService(settings_service, db_path=self.__db.db_path)
    ...
    def test_restore(self) -> None:
        ...
        new_backup_service = BackupService(new_settings_service, db_path=self.__db.db_path)
